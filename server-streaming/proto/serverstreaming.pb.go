...
var file_serverstreaming_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x00, 0x30, 0x01, 0x42, 0x03,
...
func (c *serverStreamingClient) GetServerResponse(ctx context.Context, in *Number, opts ...grpc.CallOption) (ServerStreaming_GetServerResponseClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ServerStreaming_serviceDesc.Streams[0], "/proto.ServerStreaming/GetServerResponse", opts...)
	if err != nil {
		return nil, err
	}
...
// UnimplementedServerStreamingServer can be embedded to have forward compatible implementations.
...
func RegisterServerStreamingServer(s *grpc.Server, srv ServerStreamingServer) {
	s.RegisterService(&_ServerStreaming_serviceDesc, srv)
}
...
var _ServerStreaming_serviceDesc = grpc.ServiceDesc{
