...
var file_hello_grpc_proto_rawDesc = []byte{
	...
	0x4d, 0x79, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0x00, 0x42, 0x0b, 0x5a, 0x09, 0x61, 0x70,
...
func (c *myServiceClient) MyFunction(ctx context.Context, in *MyNumber, opts ...grpc.CallOption) (*MyNumber, error) {
	out := new(MyNumber)
	err := c.cc.Invoke(ctx, "/proto.MyService/MyFunction", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MyService_MyFunction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.MyService/MyFunction",
	}
